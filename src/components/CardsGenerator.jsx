...
const CardsGenerator = ({ countries, increaseChunk, setCondition, scrollUp }) => {
	const [slicedCountries, setSlicedCountries] = useState(slice(countries, chunkLength));
		...
		<div className="countries-container">
			{!countries ? (
				...
				cardsToRender.map((country) => {
					return <Card country={country} key={country.name} scrollUp={scrollUp} />;
				})
			)}
		</div>
	);
